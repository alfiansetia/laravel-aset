...
@push('css')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('lib/jqvmap/dist/jqvmap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('lib/weathericons/css/weather-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('lib/weathericons/css/weather-icons-wind.min.css') }}">
    <link rel="stylesheet" href="{{ asset('lib/summernote/dist/summernote-bs4.css') }}">
@endpush
@section('content')
    <div class="row">
...
@push('js')
    <script src="{{ asset('lib/simpleweather/jquery.simpleWeather.min.js') }}"></script>
    <script src="{{ asset('lib/chart.js/dist/Chart.min.js') }}"></script>
    <script src="{{ asset('lib/jqvmap/dist/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('lib/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
    <script src="{{ asset('lib/summernote/dist/summernote-bs4.js') }}"></script>
    <script src="{{ asset('lib/chocolat/dist/js/jquery.chocolat.min.js') }}"></script>
