        ...
        $(document).ready(function() {
            ...
            $('#form_tracking').submit(function(e) {
                ...
                $.get("{{ route('api.tracking.index', '') }}" + '/' + code).done(function(result) {
                    ...
                    set_column('NILAI', result.data.nilai_parse)
                    ...
                    set_column('BATAS PEMAKAIAN',
                        result.data.batas > 0 ?
                        `${result.data.batas} Tahun (${result.data.batas_parse})` : '')
                    set_column('MASA PEMAKAIAN', result.data.masa_parse)
                    set_column('SISA PEMAKAIAN', result.data.sisa_parse)
